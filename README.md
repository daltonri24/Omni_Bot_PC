...
### Overview
This repo provides details and code for an in progress omni wheeled robot ultilizing ROS 2 on a Raspberry Pi 5. A Realsense D435 depth camera provides RGBD images which can be used for SLAM related tasks.  The chasis itself is structured as 3 stacking tiers built up with custom designed parts fabricated using a 3D printer.
...
<table>
    <tr>
        <td><img src="images/IMG_5533.jpg" alt="main1" width="400"/></td>
        <td><img src="images/IMG_5534.jpg" alt="main2" width="400"/></td>
    </tr>
</table>
...
2. I want to fully implement autonomous navigation while mapping. While I would love to skip straight to this, I first need to improve the mapping so I have better occupancy grids the navigation can work off of. 

## References

1. [Articulated Robotics](https://www.youtube.com/@ArticulatedRobotics/featured) - Great youtube channel with tutorials on robotics, provided great information on the parts of this project I was less familiar with.

2. UofM MBot - The robot used by many of the classes I took at the University of Michigan. Provided a great deal of inspiration in my design philosphy.

## Pictures

<table>
    <tr>
        <td><img src="images/IMG_5535.jpg" alt="Front" width="400"/></td>
        <td><img src="images/IMG_5536.jpg" alt="Right" width="400"/></td>
    </tr>
    <tr>
        <td><img src="images/IMG_5537.jpg" alt="Back" width="400"/></td>
        <td><img src="images/IMG_5538.jpg" alt="Left" width="400"/></td>
    </tr>
</table>